...
Item {
    ...
    function getWallpaperPath(): string {
        ...
        try {
            ...
            if (xhr.status === 200 || xhr.status === 0) {
                wallpaperPath = xhr.responseText;
            }
    ...
    function layer(c: color, layer: var): color {
        ...
        return layer === 0 ? Qt.alpha(c, Config.appearance.transparency.base) : alterColour(c, Config.appearance.transparency.layers, layer ?? 1);
    }
